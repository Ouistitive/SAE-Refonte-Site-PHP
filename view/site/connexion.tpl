    		...
    		<form id="connexion-form">
                <div id="identifiants">
                    <div class="connexion-texbox">
        			    <input type="text" id="fid" placeholder="Identifiant" name="ident">
                    </div>
                    <div class="connexion-texbox">
        			    <input type="password" id="fmdp" placeholder="Mot de passe" name="password">
                    </div>
                </div>
                
    			<input type="checkbox" id="checkSouvenir" name="remember-pwd" value="true">
    			  <label for="html" class="entre">Se souvenir de moi</label>
    			<a href="/" class="entre">Mot de passe oublié ?</a>
    			<a href="/" class="entre">Pas de compte ?</a>
